...
class RabbitMQQueueTest extends TestCase
{
    ...
    public function testShouldReturnExpectedNumberOfMessages()
    {
        ...
        $this->assertSame($expectedCount, $queue->size($queueIdentifier));
    }
    ...
    public function testShouldSendExpectedMessageOnPushRaw()
    {
        ...
        $queue = $this->createMock(AmqpQueue::class);
        $queue->expects($this->any())->method('getQueueName')->willReturn('aQueueName');
        ...
        $queue->pushRaw('thePayload', $queueId);
    }
    ...
    public function testShouldSetAttemptCountPropIfNotNull()
    {
        ...
        $queue->pushRaw('thePayload', 'default', ['attempts' => $expectedAttempts]);
    }
    ...
    public function testShouldSetDeliveryDelayIfDelayOptionPresent()
    {
        ...
        $queue->pushRaw('thePayload', 'default', ['delay' => $expectedDelay]);
    }

    public function testShouldSetPriorityIfPriorityOptionPresent()
    {
        $priority = 5;
        $expectedPriority = 5;
        ...
        $queue->pushRaw('thePayload', 'default', ['priority' => $priority]);
    }

    public function testShouldSetRoutinKeyIfRoutingKeyOptionPresent()
    {
        $routingKey = 'my.routing.key';
        $expectedRoutingKey = 'my.routing.key';
        ...
        $queue->pushRaw('thePayload', 'default', ['routing_key' => $routingKey]);
    }
    ...
    public function testShouldLogExceptionOnPushRaw()
    {
        ...
        $queue->pushRaw('thePayload', 'default');
    }
    ...
    public function testShouldUseBasicConsumeSubscriber()
    {
        ...
        $config['options']['queues']['default']['basic_consume'] = true;
